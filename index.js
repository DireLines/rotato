...
var ASM_CONSTS = {
  11468518: () => { if (document.fullscreenElement) return 1; },  
 11468564: () => { return Module.canvas.width; },  
 11468596: () => { return parseInt(Module.canvas.style.width); },  
 11468644: () => { document.exitFullscreen(); },  
 11468671: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 11468743: () => { if (document.fullscreenElement) return 1; },  
 11468789: () => { return Module.canvas.width; },  
 11468821: () => { return screen.width; },  
 11468846: () => { document.exitFullscreen(); },  
 11468873: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 11469067: () => { return window.innerWidth; },  
 11469093: () => { return window.innerHeight; },  
 11469120: () => { if (document.fullscreenElement) return 1; },  
 11469166: () => { return Module.canvas.width; },  
 11469198: () => { return parseInt(Module.canvas.style.width); },  
 11469246: () => { if (document.fullscreenElement) return 1; },  
 11469292: () => { return Module.canvas.width; },  
 11469324: () => { return screen.width; },  
 11469349: () => { return window.innerWidth; },  
 11469375: () => { return window.innerHeight; },  
 11469402: () => { if (document.fullscreenElement) return 1; },  
 11469448: () => { return Module.canvas.width; },  
 11469480: () => { return screen.width; },  
 11469505: () => { document.exitFullscreen(); },  
 11469532: () => { if (document.fullscreenElement) return 1; },  
 11469578: () => { return Module.canvas.width; },  
 11469610: () => { return parseInt(Module.canvas.style.width); },  
 11469658: () => { document.exitFullscreen(); },  
 11469685: ($0) => { Module.canvas.style.opacity = $0; },  
 11469723: () => { return screen.width; },  
 11469748: () => { return screen.height; },  
 11469774: () => { return window.screenX; },  
 11469801: () => { return window.screenY; },  
 11469828: () => { return window.devicePixelRatio; },  
 11469864: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 11469917: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 11469968: () => { Module.canvas.style.cursor = 'none'; },  
 11470005: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 11470261: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 11470312: () => { if (document.pointerLockElement) return 1; },  
 11470359: () => { if (document.fullscreenElement) return 1; },  
 11470405: () => { return window.innerWidth; },  
 11470431: () => { return window.innerHeight; },  
